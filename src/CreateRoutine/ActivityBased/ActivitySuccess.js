...
export default function ActivitySuccess({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.successText}>Your Activity Is added</Text>
        <Text style={styles.subText}>Go back to complete your journey</Text>
      </View>

      <TouchableOpacity
        style={styles.backBtn}
        onPress={() => navigation.navigate("AddReminderActi")}
      >
